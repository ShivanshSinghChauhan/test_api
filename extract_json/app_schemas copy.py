...
class PositionSchema(Schema):
    ...
    z = fields.Int(required=False)
    m = fields.Int(required=False)
...
class NodeSchema(Schema): # dag handler 
    id = fields.Str(required=True) 
...
class LinkSchema(Schema): #dag handler
    id = fields.Str(required=True)
    ...
    fromNode = fields.Str(required=True)
    fromPort = fields.Str(required=True)
    toNode = fields.Str(required=True)
    toPort = fields.Str(required=True)
